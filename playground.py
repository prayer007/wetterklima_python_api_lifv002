...
variable = 'TM'
layerDate = datetime.datetime(2025,5,1,0,0,0)
lat = 47
lng = 15
...
if layerDateCategory == 'd':
    ...
    timeseries = utils.get_timeseries_from_dataset(dataset_fp, variable, lat, lng)
...
layer_name = 'SPARTACUS2-YEARLY_TM_1961_19610101T000000'
variable = 'TM'
